...
public class Agenda {
    ...
    public Contacto buscarPorNombre(String nombre) {
        Contacto contactoBuscado = this.contactos.stream().filter(contacto -> contacto.getNombre() == nombre).findAny().get();

        return contactoBuscado;
    }

    public Contacto buscarPorApellido(String apellido) {
        Contacto contactoBuscado = this.contactos.stream().filter(contacto -> contacto.getApellido() == apellido).findAny().get();
